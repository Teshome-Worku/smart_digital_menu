export default function TablesPage() {
  return (
    <div className="flex flex-col items-center justify-center h-[70vh] text-center">
      ...
      <h1 className="text-3xl font-bold text-dashboard-text mb-2">Table Management</h1>
      <p className="text-dashboard-muted max-w-md mb-8">
        Set up your restaurant floor plan, manage active tables, and monitor table availability. This feature is coming soon in Phase 5.
      </p>
