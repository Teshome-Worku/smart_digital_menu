export default function SettingsPage() {
  return (
    <div className="flex flex-col items-center justify-center h-[70vh] text-center">
      ...
      <h1 className="text-3xl font-bold text-dashboard-text mb-2">Restaurant Settings</h1>
      <p className="text-dashboard-muted max-w-md mb-8">
        Manage your restaurant profile, staff permissions, business hours, and integrations. This feature is coming soon in Phase 5.
      </p>
